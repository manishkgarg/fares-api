package com.fare.statistics.common;
...
import com.fare.statistics.exceptions.CustomValidationException;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Handle MethodArgumentTypeMismatchException, when arguments type
	 * mismatches
	 */
	...
	protected ResponseEntity<Object> handleException(Exception ex) {
		...
		apiError.setMessage("An Runtime Exception occurred(Undefined)");
	...
	protected ResponseEntity<Object> handleCustomValidationException(CustomValidationException ex) {
		ApiError apiError = new ApiError(NOT_FOUND);
		apiError.setMessage("Input validation(s) failed.");
		apiError.setDebugMessage("Check sub errors for more details");
		ex.getErrorDescription().forEach(s -> apiError.addValidationError(s));
		log.error("Custom Validation Exception", ex);
		return buildResponseEntity(apiError);
	}
